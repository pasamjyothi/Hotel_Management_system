...
<div class="container">
  ...
  <?php
          ...
          if (!$settings_r['shutdown']) {
             ...
             $book_btn = "<button onclick='checkLoginToBook($login,$room_data[id])' class='btn btn-sm btn-success custom-bg shadow-none'>Book Now</button>";
          }
            ...
            echo<<<data
              <div class="col-lg-4 col-md-7">
                    <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                        <img src="$room_thumb" class="card-img-top card-img-custom" alt="...">
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-evenly mb-2">
                           $book_btn
                          <a href="room_details.php?id=$room_data[id]" class="btn btn-sm btn-dark shadow-none">More Details</a>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="col-lg-12 text-center mt-5">
      <a href="rooms.php" class="btn bt-sm btn-dark rounded-0 fw-bold shadow-none">More Rooms</a>
    </div>
  </div>
</div>
<h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">OUR FACILITIES</h2>
<div class="container">
  <div class="row justify-content-evenly px-lg-0 px-md-0 px-5 gap-x-8">
  <?php
    ...
    ?>    
    <div class="col-lg-12 text-center mt-5">
      <a href="facilities.php" class="btn bt-sm btn-outline-dark rounded-0 fw-bold shadow-none">More Facilities</a>
    </div>
  </div>
</div>
      ...
      <div class="modal-content">
        <form id="recovery_form">
          ...
          <div class="modal-body">
            ...
            <button type="button" class="btn shadow-none me-2" data-bs-toggle="modal">CANCEL</button>
...
document.getElementById('recovery_form').addEventListener('submit', (e)=>{
    e.preventDefault();
